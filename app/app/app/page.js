    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-lg shadow text-center">
          ...
          <p className="text-sm text-gray-500">12 estaciones</p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow text-center">
          <h3 className="font-bold">Barcelona</h3>
          <p className="text-sm text-gray-500">8 estaciones</p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow text-center">
          <h3 className="font-bold">Valencia</h3>
          <p className="text-sm text-gray-500">5 estaciones</p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow text-center">
          <h3 className="font-bold">Sevilla</h3>
          <p className="text-sm text-gray-500">4 estaciones</p>
        </div>
      </div>
    </div>
  );
